...
import { deleteCustomer, getCustomers } from "../../components/customer/CustomerRepo";
...
function CustomerList() {
  ...
  const [listState, requestOwners] = useAPIRequest(getCustomers);
  const [delState, requestDelete] = useAPIRequest(deleteCustomer);
        ...
        <Card.Body>
          <div className="overflow-x-auto">
            <Table>
              <Table.THead>
                <tr>
                  <Table.TH className="w-42">Name</Table.TH>
                  <Table.TH className="w-24">Gender</Table.TH>
                  <Table.TH className="w-45">Email</Table.TH>
