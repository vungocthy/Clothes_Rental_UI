...
import { addCustomer, saveCustomer } from "../CustomerRepo";

export function CustomerEdit({owner = { name: "" }, handleClose }) {
  //console.log(owner);
  const [state, requestSave] = useAPIRequest(saveCustomer);
...
export function CustomerAdd({owner = { name: "" }, handleClose }) {
  //console.log(owner);
  const [state, requestAdd] = useAPIRequest(addCustomer);
