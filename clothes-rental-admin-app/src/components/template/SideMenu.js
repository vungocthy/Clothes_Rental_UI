...
// ];
  ...
  const shopMenus = [
      ...
      { path: "/shops/:id/products", title: "Products" },
      { path: "/shops/:id/combos", title: "Combos" }
    ];
    ...
    <div className="bg-gray-800 overflow-x-hidden h-screen scrollbar-none">
      ...
      <div className="mt-[84px] mb-5">
        <ul className="lg:mt-2 lg:space-y-3 h-min">
          ...
          {/* <SideMenuDisclosure list={shopMenus}>
          ...
          >
            <UserIcon className="icon" />
            <span className="hidden lg:inline flex-grow">Owners</span>
          </NavLink>
          ...
          >
            <UserIcon className="icon" />
            <span className="hidden lg:inline flex-grow">Customers</span>
          </NavLink> */}
{/* 
          <NavLink
            to="/books"
